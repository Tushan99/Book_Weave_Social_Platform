    ...
    <div className="w-full">
      <div className="text-center mb-8">
        ...
        <p className="text-neutral-600">
          Start your reading journey with fellow book lovers
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <FiUserCheck className="h-5 w-5 text-neutral-400" />
            </div>
            <input
              id="username"
              type="text"
              autoComplete="username"
              className={`form-input pl-10 ${errors.username ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''}`}
        ...
        <div className="flex items-start">
          ...
          />
          <label htmlFor="terms" className="ml-3 block text-sm text-neutral-900">
            I agree to the{' '}
